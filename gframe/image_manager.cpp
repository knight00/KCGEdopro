...
bool ImageManager::Initial() {
	...
	tLv[0] = loadTextureAnySize(EPRO_TEXT("lv1"sv));
	ASSIGN_DEFAULT(tLv[0]);
	tLv[1] = loadTextureAnySize(EPRO_TEXT("lv2"sv));
	ASSIGN_DEFAULT(tLv[1]);
	tLv[2] = loadTextureAnySize(EPRO_TEXT("lv3"sv));
	ASSIGN_DEFAULT(tLv[2]);
	tLv[3] = loadTextureAnySize(EPRO_TEXT("lv4"sv));
	ASSIGN_DEFAULT(tLv[3]);
	tLv[4] = loadTextureAnySize(EPRO_TEXT("lv5"sv));
	ASSIGN_DEFAULT(tLv[4]);
	tLv[5] = loadTextureAnySize(EPRO_TEXT("lv6"sv));
	ASSIGN_DEFAULT(tLv[5]);
	tLv[6] = loadTextureAnySize(EPRO_TEXT("lv7"sv));
	ASSIGN_DEFAULT(tLv[6]);
	tLv[7] = loadTextureAnySize(EPRO_TEXT("lv8"sv));
	ASSIGN_DEFAULT(tLv[7]);
	tLv[8] = loadTextureAnySize(EPRO_TEXT("lv9"sv));
	ASSIGN_DEFAULT(tLv[8]);
	tLv[9] = loadTextureAnySize(EPRO_TEXT("lv10"sv));
	ASSIGN_DEFAULT(tLv[9]);
	tLv[10] = loadTextureAnySize(EPRO_TEXT("lv11"sv));
	ASSIGN_DEFAULT(tLv[10]);
	tLv[11] = loadTextureAnySize(EPRO_TEXT("lv12"sv));
	ASSIGN_DEFAULT(tLv[11]);
	tLv[12] = loadTextureAnySize(EPRO_TEXT("lv13"sv));
	ASSIGN_DEFAULT(tLv[12]);
	tRk[0] = loadTextureAnySize(EPRO_TEXT("rank1"sv));
	ASSIGN_DEFAULT(tRk[0]);
	tRk[1] = loadTextureAnySize(EPRO_TEXT("rank2"sv));
	ASSIGN_DEFAULT(tRk[1]);
	tRk[2] = loadTextureAnySize(EPRO_TEXT("rank3"sv));
	ASSIGN_DEFAULT(tRk[2]);
	tRk[3] = loadTextureAnySize(EPRO_TEXT("rank4"sv));
	ASSIGN_DEFAULT(tRk[3]);
	tRk[4] = loadTextureAnySize(EPRO_TEXT("rank5"sv));
	ASSIGN_DEFAULT(tRk[4]);
	tRk[5] = loadTextureAnySize(EPRO_TEXT("rank6"sv));
	ASSIGN_DEFAULT(tRk[5]);
	tRk[6] = loadTextureAnySize(EPRO_TEXT("rank7"sv));
	ASSIGN_DEFAULT(tRk[6]);
	tRk[7] = loadTextureAnySize(EPRO_TEXT("rank8"sv));
	ASSIGN_DEFAULT(tRk[7]);
	tRk[8] = loadTextureAnySize(EPRO_TEXT("rank9"sv));
	ASSIGN_DEFAULT(tRk[8]);
	tRk[9] = loadTextureAnySize(EPRO_TEXT("rank10"sv));
	ASSIGN_DEFAULT(tRk[9]);
	tRk[10] = loadTextureAnySize(EPRO_TEXT("rank11"sv));
	ASSIGN_DEFAULT(tRk[10]);
	tRk[11] = loadTextureAnySize(EPRO_TEXT("rank12"sv));
	ASSIGN_DEFAULT(tRk[11]);
	tRk[12] = loadTextureAnySize(EPRO_TEXT("rank13"sv));
	ASSIGN_DEFAULT(tRk[12]);
	tLS[0] = loadTextureAnySize(EPRO_TEXT("lscale0"sv));
	ASSIGN_DEFAULT(tLS[0]);
	tLS[1] = loadTextureAnySize(EPRO_TEXT("lscale1"sv));
	ASSIGN_DEFAULT(tLS[1]);
	tLS[2] = loadTextureAnySize(EPRO_TEXT("lscale2"sv));
	ASSIGN_DEFAULT(tLS[2]);
	tLS[3] = loadTextureAnySize(EPRO_TEXT("lscale3"sv));
	ASSIGN_DEFAULT(tLS[3]);
	tLS[4] = loadTextureAnySize(EPRO_TEXT("lscale4"sv));
	ASSIGN_DEFAULT(tLS[4]);
	tLS[5] = loadTextureAnySize(EPRO_TEXT("lscale5"sv));
	ASSIGN_DEFAULT(tLS[5]);
	tLS[6] = loadTextureAnySize(EPRO_TEXT("lscale6"sv));
	ASSIGN_DEFAULT(tLS[6]);
	tLS[7] = loadTextureAnySize(EPRO_TEXT("lscale7"sv));
	ASSIGN_DEFAULT(tLS[7]);
	tLS[8] = loadTextureAnySize(EPRO_TEXT("lscale8"sv));
	ASSIGN_DEFAULT(tLS[8]);
	tLS[9] = loadTextureAnySize(EPRO_TEXT("lscale9"sv));
	ASSIGN_DEFAULT(tLS[9]);
	tLS[10] = loadTextureAnySize(EPRO_TEXT("lscale10"sv));
	ASSIGN_DEFAULT(tLS[10]);
	tLS[11] = loadTextureAnySize(EPRO_TEXT("lscale11"sv));
	ASSIGN_DEFAULT(tLS[11]);
	tLS[12] = loadTextureAnySize(EPRO_TEXT("lscale12"sv));
	ASSIGN_DEFAULT(tLS[12]);
	tLS[13] = loadTextureAnySize(EPRO_TEXT("rscale13"sv));
	ASSIGN_DEFAULT(tLS[13]);
	tRS[0] = loadTextureAnySize(EPRO_TEXT("rscale0"sv));
	ASSIGN_DEFAULT(tRS[0]);
	tRS[1] = loadTextureAnySize(EPRO_TEXT("rscale1"sv));
	ASSIGN_DEFAULT(tRS[1]);
	tRS[2] = loadTextureAnySize(EPRO_TEXT("rscale2"sv));
	ASSIGN_DEFAULT(tRS[2]);
	tRS[3] = loadTextureAnySize(EPRO_TEXT("rscale3"sv));
	ASSIGN_DEFAULT(tRS[3]);
	tRS[4] = loadTextureAnySize(EPRO_TEXT("rscale4"sv));
	ASSIGN_DEFAULT(tRS[4]);
	tRS[5] = loadTextureAnySize(EPRO_TEXT("rscale5"sv));
	ASSIGN_DEFAULT(tRS[5]);
	tRS[6] = loadTextureAnySize(EPRO_TEXT("rscale6"sv));
	ASSIGN_DEFAULT(tRS[6]);
	tRS[7] = loadTextureAnySize(EPRO_TEXT("rscale7"sv));
	ASSIGN_DEFAULT(tRS[7]);
	tRS[8] = loadTextureAnySize(EPRO_TEXT("rscale8"sv));
	ASSIGN_DEFAULT(tRS[8]);
	tRS[9] = loadTextureAnySize(EPRO_TEXT("rscale9"sv));
	ASSIGN_DEFAULT(tRS[9]);
	tRS[10] = loadTextureAnySize(EPRO_TEXT("rscale10"sv));
	ASSIGN_DEFAULT(tRS[10]);
	tRS[11] = loadTextureAnySize(EPRO_TEXT("rscale11"sv));
	ASSIGN_DEFAULT(tRS[11]);
	tRS[12] = loadTextureAnySize(EPRO_TEXT("rscale12"sv));
	ASSIGN_DEFAULT(tRS[12]);
	tRS[13] = loadTextureAnySize(EPRO_TEXT("rscale13"sv));
	ASSIGN_DEFAULT(tRS[13]);
	tGodAtt = loadTextureAnySize(EPRO_TEXT("att-god"sv));
	ASSIGN_DEFAULT(tGodAtt);
	tDARKAtt = loadTextureAnySize(EPRO_TEXT("att-dark"sv));
	ASSIGN_DEFAULT(tDARKAtt);
	tLightAtt = loadTextureAnySize(EPRO_TEXT("att-light"sv));
	ASSIGN_DEFAULT(tLightAtt);
	tWindAtt = loadTextureAnySize(EPRO_TEXT("att-wind"sv));
	ASSIGN_DEFAULT(tWindAtt);
	tEarthAtt = loadTextureAnySize(EPRO_TEXT("att-earth"sv));
	ASSIGN_DEFAULT(tEarthAtt);
	tFireAtt = loadTextureAnySize(EPRO_TEXT("att-fire"sv));
	ASSIGN_DEFAULT(tFireAtt);
	tWaterAtt = loadTextureAnySize(EPRO_TEXT("att-water"sv));
	ASSIGN_DEFAULT(tWaterAtt);
	tLinkZone = loadTextureAnySize(EPRO_TEXT("linkzone"sv));
	ASSIGN_DEFAULT(tLinkZone);
	tLinkMarker[0] = loadTextureAnySize(EPRO_TEXT("linkarrow1"sv));
	ASSIGN_DEFAULT(tLinkMarker[0]);
	tLinkMarker[1] = loadTextureAnySize(EPRO_TEXT("linkarrow2"sv));
	ASSIGN_DEFAULT(tLinkMarker[1]);
	tLinkMarker[2] = loadTextureAnySize(EPRO_TEXT("linkarrow3"sv));
	ASSIGN_DEFAULT(tLinkMarker[2]);
	tLinkMarker[3] = loadTextureAnySize(EPRO_TEXT("linkarrow4"sv));
	ASSIGN_DEFAULT(tLinkMarker[3]);
	tLinkMarker[4] = loadTextureAnySize(EPRO_TEXT("linkarrow5"sv));
	ASSIGN_DEFAULT(tLinkMarker[4]);
	tLinkMarker[5] = loadTextureAnySize(EPRO_TEXT("linkarrow6"sv));
	ASSIGN_DEFAULT(tLinkMarker[5]);
	tLinkMarker[6] = loadTextureAnySize(EPRO_TEXT("linkarrow7"sv));
	ASSIGN_DEFAULT(tLinkMarker[6]);
	tLinkMarker[7] = loadTextureAnySize(EPRO_TEXT("linkarrow8"sv));
	ASSIGN_DEFAULT(tLinkMarker[7]);
	tNormType = loadTextureAnySize(EPRO_TEXT("card-normal"sv));
	ASSIGN_DEFAULT(tNormType);
	tEffectType = loadTextureAnySize(EPRO_TEXT("card-effect"sv));
	ASSIGN_DEFAULT(tEffectType);
	tFusionType = loadTextureAnySize(EPRO_TEXT("card-fusion"sv));
	ASSIGN_DEFAULT(tFusionType);
	tSynchType = loadTextureAnySize(EPRO_TEXT("card-synch"sv));
	ASSIGN_DEFAULT(tSynchType);
	tXyzType = loadTextureAnySize(EPRO_TEXT("card-xyz"sv));
	ASSIGN_DEFAULT(tXyzType);
	tRitualType = loadTextureAnySize(EPRO_TEXT("card-ritual"sv));
	ASSIGN_DEFAULT(tRitualType);
	tLinkType = loadTextureAnySize(EPRO_TEXT("card-link"sv));
	ASSIGN_DEFAULT(tLinkType);
	tNormPendType = loadTextureAnySize(EPRO_TEXT("card-normpend"sv));
	ASSIGN_DEFAULT(tNormPendType);
	tEffPendType = loadTextureAnySize(EPRO_TEXT("card-effpend"sv));
	ASSIGN_DEFAULT(tEffPendType);
	tFusPendType = loadTextureAnySize(EPRO_TEXT("card-fuspend"sv));
	ASSIGN_DEFAULT(tFusPendType);
	tSynPendType = loadTextureAnySize(EPRO_TEXT("card-synpend"sv));
	ASSIGN_DEFAULT(tSynPendType);
	tXyzPendType = loadTextureAnySize(EPRO_TEXT("card-xyzpend"sv));
	ASSIGN_DEFAULT(tXyzPendType);
	tRitPendType = loadTextureAnySize(EPRO_TEXT("card-ritpend"sv));
	ASSIGN_DEFAULT(tRitPendType);
	tLinkPendType = loadTextureAnySize(EPRO_TEXT("card-linkpend"sv));
	ASSIGN_DEFAULT(tLinkPendType);
	tTokenType = loadTextureAnySize(EPRO_TEXT("card-token"sv));
