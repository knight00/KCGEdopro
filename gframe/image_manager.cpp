...
bool ImageManager::Initial() {
	...
	tLv[0] = loadTextureFixedSize(EPRO_TEXT("lv1"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[0]);
	tLv[1] = loadTextureFixedSize(EPRO_TEXT("lv2"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[1]);
	tLv[2] = loadTextureFixedSize(EPRO_TEXT("lv3"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[2]);
	tLv[3] = loadTextureFixedSize(EPRO_TEXT("lv4"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[3]);
	tLv[4] = loadTextureFixedSize(EPRO_TEXT("lv5"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[4]);
	tLv[5] = loadTextureFixedSize(EPRO_TEXT("lv6"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[5]);
	tLv[6] = loadTextureFixedSize(EPRO_TEXT("lv7"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[6]);
	tLv[7] = loadTextureFixedSize(EPRO_TEXT("lv8"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[7]);
	tLv[8] = loadTextureFixedSize(EPRO_TEXT("lv9"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[8]);
	tLv[9] = loadTextureFixedSize(EPRO_TEXT("lv10"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[9]);
	tLv[10] = loadTextureFixedSize(EPRO_TEXT("lv11"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[10]);
	tLv[11] = loadTextureFixedSize(EPRO_TEXT("lv12"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[11]);
	tLv[12] = loadTextureFixedSize(EPRO_TEXT("lv13"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLv[12]);
	tRk[0] = loadTextureFixedSize(EPRO_TEXT("rank1"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[0]);
	tRk[1] = loadTextureFixedSize(EPRO_TEXT("rank2"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[1]);
	tRk[2] = loadTextureFixedSize(EPRO_TEXT("rank3"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[2]);
	tRk[3] = loadTextureFixedSize(EPRO_TEXT("rank4"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[3]);
	tRk[4] = loadTextureFixedSize(EPRO_TEXT("rank5"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[4]);
	tRk[5] = loadTextureFixedSize(EPRO_TEXT("rank6"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[5]);
	tRk[6] = loadTextureFixedSize(EPRO_TEXT("rank7"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[6]);
	tRk[7] = loadTextureFixedSize(EPRO_TEXT("rank8"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[7]);
	tRk[8] = loadTextureFixedSize(EPRO_TEXT("rank9"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[8]);
	tRk[9] = loadTextureFixedSize(EPRO_TEXT("rank10"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[9]);
	tRk[10] = loadTextureFixedSize(EPRO_TEXT("rank11"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[10]);
	tRk[11] = loadTextureFixedSize(EPRO_TEXT("rank12"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[11]);
	tRk[12] = loadTextureFixedSize(EPRO_TEXT("rank13"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRk[12]);
	tLS[0] = loadTextureFixedSize(EPRO_TEXT("lscale0"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[0]);
	tLS[1] = loadTextureFixedSize(EPRO_TEXT("lscale1"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[1]);
	tLS[2] = loadTextureFixedSize(EPRO_TEXT("lscale2"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[2]);
	tLS[3] = loadTextureFixedSize(EPRO_TEXT("lscale3"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[3]);
	tLS[4] = loadTextureFixedSize(EPRO_TEXT("lscale4"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[4]);
	tLS[5] = loadTextureFixedSize(EPRO_TEXT("lscale5"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[5]);
	tLS[6] = loadTextureFixedSize(EPRO_TEXT("lscale6"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[6]);
	tLS[7] = loadTextureFixedSize(EPRO_TEXT("lscale7"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[7]);
	tLS[8] = loadTextureFixedSize(EPRO_TEXT("lscale8"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[8]);
	tLS[9] = loadTextureFixedSize(EPRO_TEXT("lscale9"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[9]);
	tLS[10] = loadTextureFixedSize(EPRO_TEXT("lscale10"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[10]);
	tLS[11] = loadTextureFixedSize(EPRO_TEXT("lscale11"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[11]);
	tLS[12] = loadTextureFixedSize(EPRO_TEXT("lscale12"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[12]);
	tLS[13] = loadTextureFixedSize(EPRO_TEXT("rscale13"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLS[13]);
	tRS[0] = loadTextureFixedSize(EPRO_TEXT("rscale0"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[0]);
	tRS[1] = loadTextureFixedSize(EPRO_TEXT("rscale1"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[1]);
	tRS[2] = loadTextureFixedSize(EPRO_TEXT("rscale2"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[2]);
	tRS[3] = loadTextureFixedSize(EPRO_TEXT("rscale3"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[3]);
	tRS[4] = loadTextureFixedSize(EPRO_TEXT("rscale4"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[4]);
	tRS[5] = loadTextureFixedSize(EPRO_TEXT("rscale5"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[5]);
	tRS[6] = loadTextureFixedSize(EPRO_TEXT("rscale6"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[6]);
	tRS[7] = loadTextureFixedSize(EPRO_TEXT("rscale7"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[7]);
	tRS[8] = loadTextureFixedSize(EPRO_TEXT("rscale8"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[8]);
	tRS[9] = loadTextureFixedSize(EPRO_TEXT("rscale9"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[9]);
	tRS[10] = loadTextureFixedSize(EPRO_TEXT("rscale10"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[10]);
	tRS[11] = loadTextureFixedSize(EPRO_TEXT("rscale11"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[11]);
	tRS[12] = loadTextureFixedSize(EPRO_TEXT("rscale12"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[12]);
	tRS[13] = loadTextureFixedSize(EPRO_TEXT("rscale13"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRS[13]);
	tGodAtt = loadTextureFixedSize(EPRO_TEXT("att-god"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tGodAtt);
	tDARKAtt = loadTextureFixedSize(EPRO_TEXT("att-dark"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tDARKAtt);
	tLightAtt = loadTextureFixedSize(EPRO_TEXT("att-light"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLightAtt);
	tWindAtt = loadTextureFixedSize(EPRO_TEXT("att-wind"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tWindAtt);
	tEarthAtt = loadTextureFixedSize(EPRO_TEXT("att-earth"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tEarthAtt);
	tFireAtt = loadTextureFixedSize(EPRO_TEXT("att-fire"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tFireAtt);
	tWaterAtt = loadTextureFixedSize(EPRO_TEXT("att-water"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tWaterAtt);
	tLinkZone = loadTextureFixedSize(EPRO_TEXT("linkzone"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkZone);
	tLinkMarker[0] = loadTextureFixedSize(EPRO_TEXT("linkarrow1"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[0]);
	tLinkMarker[1] = loadTextureFixedSize(EPRO_TEXT("linkarrow2"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[1]);
	tLinkMarker[2] = loadTextureFixedSize(EPRO_TEXT("linkarrow3"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[2]);
	tLinkMarker[3] = loadTextureFixedSize(EPRO_TEXT("linkarrow4"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[3]);
	tLinkMarker[4] = loadTextureFixedSize(EPRO_TEXT("linkarrow5"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[4]);
	tLinkMarker[5] = loadTextureFixedSize(EPRO_TEXT("linkarrow6"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[5]);
	tLinkMarker[6] = loadTextureFixedSize(EPRO_TEXT("linkarrow7"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[6]);
	tLinkMarker[7] = loadTextureFixedSize(EPRO_TEXT("linkarrow8"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkMarker[7]);
	tNormType = loadTextureFixedSize(EPRO_TEXT("card-normal"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tNormType);
	tEffectType = loadTextureFixedSize(EPRO_TEXT("card-effect"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tEffectType);
	tFusionType = loadTextureFixedSize(EPRO_TEXT("card-fusion"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tFusionType);
	tSynchType = loadTextureFixedSize(EPRO_TEXT("card-synch"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tSynchType);
	tXyzType = loadTextureFixedSize(EPRO_TEXT("card-xyz"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tXyzType);
	tRitualType = loadTextureFixedSize(EPRO_TEXT("card-ritual"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRitualType);
	tLinkType = loadTextureFixedSize(EPRO_TEXT("card-link"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkType);
	tNormPendType = loadTextureFixedSize(EPRO_TEXT("card-normpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tNormPendType);
	tEffPendType = loadTextureFixedSize(EPRO_TEXT("card-effpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tEffPendType);
	tFusPendType = loadTextureFixedSize(EPRO_TEXT("card-fuspend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tFusPendType);
	tSynPendType = loadTextureFixedSize(EPRO_TEXT("card-synpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tSynPendType);
	tXyzPendType = loadTextureFixedSize(EPRO_TEXT("card-xyzpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tXyzPendType);
	tRitPendType = loadTextureFixedSize(EPRO_TEXT("card-ritpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tRitPendType);
	tLinkPendType = loadTextureFixedSize(EPRO_TEXT("card-linkpend"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
	ASSIGN_DEFAULT(tLinkPendType);
	tTokenType = loadTextureFixedSize(EPRO_TEXT("card-token"sv), CARD_IMG_WIDTH, CARD_IMG_HEIGHT);
