...
OPTION(std::wstring, nickname, L"KCG")
...
OPTION(bool, NoSwap, false)
OPTION(bool, chkOppLP, false)
OPTION(bool, chkOppHand, false)
///kdiy//////////
...
OPTION(bool, botMute, true)
OPTION(int, lastBot, 0)
///kdiy//////////
OPTION(std::wstring, lastdeckfolder, L"" )
OPTION(std::wstring, lastAIdeckfolder, L"" )
OPTION(std::wstring, lastAIdeck, L"" )
OPTION(uint8_t, hdpic, 0)
OPTION(uint32_t, botSeed, 0)
OPTION(std::wstring, lastLocalServer, L"" )
OPTION(uint32_t, lastlocalallowedcards, 0)
OPTION(uint32_t, localtimeLimit, 3)
OPTION(uint32_t, duelrule, 4)
OPTION(bool, randomtexture, true)
OPTION(bool, randomwallpaper, true)
OPTION(bool, videowallpaper, false)
OPTION(bool, randomvideowallpaper, true)
OPTION(std::string, videowallpapertexture, "" )
OPTION(bool, randombg, true)
OPTION(std::wstring, randombgtexture, L"" )
OPTION(bool, randombgdeck, true)
OPTION(std::wstring, randombgdecktexture, L"" )
OPTION(bool, randombgmenu, true)
OPTION(std::wstring, randombgmenutexture, L"" )
OPTION(bool, randomcover, true)
OPTION(std::wstring, randomcovertexture, L"" )
OPTION(bool, randomcoverextra, true)
OPTION(std::wstring, randomcoverextratexture, L"" )
OPTION(bool, randomcover2, true)
OPTION(std::wstring, randomcover2texture, L"" )
OPTION(bool, randomcover2extra, true)
OPTION(std::wstring, randomcover2extratexture, L"" )
OPTION(bool, randomattack, true)
OPTION(std::wstring, randomattacktexture, L"" )
OPTION(bool, randomact, true)
OPTION(std::wstring, randomacttexture, L"" )
OPTION(bool, randomchain, true)
OPTION(std::wstring, randomchaintexture, L"" )
OPTION(bool, randomnegate, true)
OPTION(std::wstring, randomnegatetexture, L"" )
OPTION(bool, randommask, true)
OPTION(std::wstring, randommasktexture, L"" )
OPTION(bool, randomequip, true)
OPTION(std::wstring, randomequiptexture, L"" )
OPTION(bool, randomtarget, true)
OPTION(std::wstring, randomtargettexture, L"" )
OPTION(bool, randomchaintarget, true)
OPTION(std::wstring, randomchaintargettexture, L"" )
OPTION(bool, randommorra, true)
OPTION(std::wstring, randommorratexture, L"" )
OPTION(bool, randomunknown, true)
OPTION(std::wstring, randomunknowntexture, L"" )
OPTION(bool, randomlim, true)
OPTION(std::wstring, randomlimtexture, L"" )
OPTION(bool, randomot, true)
OPTION(std::wstring, randomottexture, L"" )
OPTION(bool, randommsetting, true)
OPTION(std::wstring, randommsettingtexture, L"" )
OPTION(bool, closeup, true)
OPTION(bool, painting, true)
OPTION(bool, enablessound, true)
OPTION(bool, enablecsound, true)
OPTION(bool, enableasound, true)
OPTION(bool, enableanime, false)
OPTION(bool, enablesanime, false)
OPTION(bool, enablecanime, false)
OPTION(bool, enableaanime, false)
OPTION(bool, enableanimesound, true)
OPTION(bool, enablefanime, false)
OPTION(bool, enablemcanime, false)
OPTION(bool, animefull, true)
...
OPTION_ALIASED(bool, chkAutoChain, autochain, true)
