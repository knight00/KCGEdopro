...
public:
	...
	std::vector<epro::path_string> textcharacter[CHARACTER_VOICE-1+CHARACTER_STORY_ONLY] = {
		...
		{EPRO_TEXT("yuma"),EPRO_TEXT("yuma_human"),EPRO_TEXT("ZEXAL"),EPRO_TEXT("ZEXAL2")},
		{EPRO_TEXT("shark")},
		{EPRO_TEXT("kaito")},
		{EPRO_TEXT("tori")},
		{EPRO_TEXT("tetsuo")},
		...
		{EPRO_TEXT("DonThousand")}, //76
		
		{EPRO_TEXT("yuya"),EPRO_TEXT("yuya_main"),EPRO_TEXT("yugo"),EPRO_TEXT("yuto"),EPRO_TEXT("yuri")},
		{EPRO_TEXT("declan")},
		{EPRO_TEXT("shay")},
		{EPRO_TEXT("sora")},
